...
# ------------------------------------------- 4b. Illustrator preview with artboard margins + frame line
def margin_px(x, y):
    if x == 0 or y == 0 or x == 99:                  # thin frame at the edge
        return (0, 0, 0, 255)
    if 30 <= x < 70 and 20 <= y < 60:
        return (0, 0, 255, 255)
    return (255, 255, 255, 255)
prev = tiff_palette(100, 80, margin_px, bps_count=1)
open(f"{OUT}/ai_margin_preview.eps", "wb").write(dos_eps(ai_ps, prev))
